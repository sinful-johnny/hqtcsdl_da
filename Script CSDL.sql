...
CREATE TABLE TAI_KHOAN(
	ID_TAIKHOAN VARCHAR(5) NOT NULL,
	HOTEN NVARCHAR(30),
	SDT CHAR(11) UNIQUE,
	NGAYSINH DATE,
	EMAIL VARCHAR(30),
...
CREATE TABLE QUAN_TRI_VIEN(
	ID_QTV VARCHAR(5) NOT NULL,
	ID_TAIKHOAN VARCHAR(5) UNIQUE,
	CONSTRAINT pk_QUAN_TRI_VIEN PRIMARY KEY(ID_QTV),
)
GO

CREATE TABLE NHAN_VIEN(
	ID_NV VARCHAR(5) NOT NULL,
	ID_TAIKHOAN VARCHAR(5) UNIQUE,
...
CREATE TABLE DON_THUOC(
	ID_DONTHUOC VARCHAR(5) NOT NULL,
	ID_BA VARCHAR (5),
	THANHTIEN MONEY,
	ID_HOADON VARCHAR(5),
